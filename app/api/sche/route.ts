...
function buildPlan(items: ParsedItem[], energy: EnergyLevel, dateISO: string): PlanResponse {
  ...
  // small breaks between flex blocks
  ...
  if (used < cap && flex.length > 0 && flexIndex < flex.length) {
